          ...
          {activeSection === 'results' && aggregate !== null && !showTestPattern && !showFacts && !showMerits && (
            <div className="space-y-6">
              ...
              <div className="flex justify-center mb-4 sm:mb-6">
                <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 flex items-center justify-center rounded-full bg-midnight-blue/30 border-8 border-electric-blue/30">
                  <div className="text-center w-full px-2">
                    <span className="block text-2xl sm:text-3xl md:text-4xl font-bold text-electric-blue">{aggregate.toFixed(2)}%</span>
                    <span className="text-xs sm:text-sm text-gray-300">Aggregate Score</span>
                    {admissionPrediction && (
                      <div className="mt-1 flex justify-center">
                        <span className={`inline-block mr-2 px-2 py-1 rounded text-[10px] sm:text-xs ${getRatingColor(admissionPrediction.rating)} text-deep-space font-medium`}>
              ...
              {/* Eligibility Table */}
              <div className="mt-8">
                <EligibilityTable aggregate={aggregate} />
              </div>
